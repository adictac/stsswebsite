 ...
 * Equal height template.
 *
 * This template can be overriden by copying this file to your-theme/bs-isotope-main/sc-equal-height.php
 *
 * @author 		bootScore
 * @package 	bS Isotope
 * @version     1.0.0

Registers the Equal Height Shortcode [bs-isotope-equal-height type="post" tax="category" cat_parent="CATEGORY PARENT ID"] or [bs-isotope-equal-height type="isotope" tax="isotope_category" cat_parent="CATEGORY PARENT ID"]
*/


// Isotope Grid Equal Height Shortcode
add_shortcode( 'bs-isotope-equal-height', 'isotope_equal_height_shortcode' );
function isotope_equal_height_shortcode( $atts ) {
	ob_start();
...
<div class="d-block text-center mb-4">
    <div id="filters-equal-height" class="filter-buttons btn-group">
...
<div id="equal-height" class="row">
    ...
    <div class="<?php echo $termsString; ?> item col-md-6 col-lg-4 col-xxl-3"> <?php // 'item' is used as an identifier (see Setp 5, line 6) ?>
        ...
        <div class="card mb-4 equal-height">
